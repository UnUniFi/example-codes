...
async function post_tx_bank_msg_send(properties, context) {
  //Define functions
...
async function onClickPostTxBankMsgSend() {
  properties.toAddress = document.getElementById('toAddress').value;
  properties.amount = document.getElementById('amount').value;
  properties.denom = document.getElementById('denom').value;
  await post_tx_bank_msg_send(properties, context);
}
