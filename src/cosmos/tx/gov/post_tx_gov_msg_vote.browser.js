...
properties.chainId = 'ununifi-alpha-test-v3';
properties.chainName = 'UnUniFi (Alpha-v3)';
...
properties.rest = 'https://ununifi-alpha-test-v3.cauchye.net:1318';
properties.websocket = 'ws://ununifi-alpha-test-v3.cauchye.net:26657';
...
async function post_tx_gov_msg_vote(properties, context) {
  //Define functions
...
async function onClickPostTxGovMsgVote() {
  await post_tx_gov_msg_vote(properties, context);
}
