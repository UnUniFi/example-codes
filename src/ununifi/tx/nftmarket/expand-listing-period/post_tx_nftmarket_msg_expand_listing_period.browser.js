...
async function post_tx_nftmarket_msg_expand_listing_period(properties, context) {
  //Define functions
...
async function onClickPostTxNftMsgExpandListingPeriod() {
  properties.nftId = document.getElementById('nft_id').value;
  properties.classId = document.getElementById('nft_id').value;
  await post_tx_nftmarket_msg_expand_listing_period(properties, context);
}
