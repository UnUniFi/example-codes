...
async function post_tx_nftmarket_msg_listnft(properties, context) {
  ...
  const msg = new ununificlient.proto.ununifi.nftmarket.MsgListNft({
    ...
    bid_token: properties.bid_token,
    min_bid: properties.min_bid,
...
async function onClickPostTxNftMsgListNft() {
  ...
  properties.class_id = document.getElementById('nft_id').value;
  // properties.listing_type = document.getElementById('listing_type').value;
  properties.bid_token = document.getElementById('bid_token').value;
  properties.min_bid = document.getElementById('min_bid').value;
  // properties.bid_active_rank = document.getElementById('bid_active_rank').value;
