...
export const convertUnknownAccountToBaseAccount = (
  ...
  if (unknownAccount === undefined) {
    ...
    unknownAccount instanceof proto.cosmos.vesting.v1beta1.BaseVestingAccount
  ) {
    if (unknownAccount.base_account === null) {
      return undefined;
    }
    return new proto.cosmos.auth.v1beta1.BaseAccount(
      unknownAccount.base_account
    );
  } else if (
    unknownAccount instanceof
    ...
    unknownAccount instanceof proto.cosmos.vesting.v1beta1.DelayedVestingAccount
  ) {
    if (unknownAccount.base_vesting_account?.base_account === null) {
      return undefined;
    }
    ...
    unknownAccount instanceof proto.cosmos.auth.v1beta1.ModuleAccount
  ) {
    if (unknownAccount.base_account === null) {
      return undefined;
    }
